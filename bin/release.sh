...
VERSION_FILE="src/Http/Client.php"
STASHED=false
...
sed -i.bak "s/apiVersion = '${CURRENT_VERSION}'/apiVersion = '${NEW_VERSION}'/" "$VERSION_FILE"
...
echo "  GitHub:    https://github.com/${REPO}/releases/tag/${TAG}"
echo "  Packagist: https://packagist.org/packages/chartmogul/chartmogul-php#${TAG}"
