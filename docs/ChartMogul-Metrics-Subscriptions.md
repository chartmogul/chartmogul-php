ChartMogul\Metrics\Subscriptions
===============
...
### ENTRY_CLASS
    ...
    const ENTRY_CLASS = \ChartMogul\Metrics\Subscription::class
...
### all
    ...
    \Doctrine\Common\Collections\ArrayCollection|self ChartMogul\Metrics\Subscriptions::all(array $data, \ChartMogul\Http\ClientInterface|null $client)
