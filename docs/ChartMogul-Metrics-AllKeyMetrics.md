ChartMogul\Metrics\AllKeyMetrics
===============
...
### all
    ...
    \Doctrine\Common\Collections\ArrayCollection|self ChartMogul\Metrics\AllKeyMetrics::all(array $data, \ChartMogul\Http\ClientInterface|null $client)
